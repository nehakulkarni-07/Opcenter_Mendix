...
import adjustFont, {
  height,
  width,
} from "../../../atlas_core/native/core/helpers/_functions/adjustfont";
import {
  anyColorToRgbString,
  setColorBasedOnBackground,
  setContrastScale,
} from "../../../atlas_core/native/core/helpers/_functions/convertcolors";
/*
...
export const headerImageSize = headerHeight - headerPadding * 2;
...
const callToActionSizeFactor = 0.4;
const maxCallToActionSize = adjustFont(
  (width > height ? height : width) * callToActionSizeFactor
);
const callToActionCornerSize = maxCallToActionSize / 3;
export const callToAction = {
  maxCallToActionSize,
  callToActionCornerSize,
  borderColor: apolloColors.BLUE_DARK,
  borderWidth: 7,
};
