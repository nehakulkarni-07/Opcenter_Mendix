...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (mendixObject.isInstanceOf("DISW_DesignSystem.AccountProfilePicture")) {
			return disw_designsystem.proxies.AccountProfilePicture.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("Administration.AccountProfilePicture")) {
			return administration.proxies.AccountProfilePicture.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("EXCR_MfgOrderManagement_API.ImageConvert")) {
			return excr_mfgordermanagement_api.proxies.ImageConvert.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("EXCR_MfgOrderManagement.ImageConvert")) {
			return excr_mfgordermanagement.proxies.ImageConvert.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("EXCR_MfgOrderManagement.TasklistImageConvert")) {
