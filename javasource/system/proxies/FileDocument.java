...
public class FileDocument implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	...
	{
		if (mendixObject.isInstanceOf("EXCR_ResourceManagement.DHR")) {
			return excr_resourcemanagement.proxies.DHR.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("EXCR_OperatorLog.Doc")) {
			return excr_operatorlog.proxies.Doc.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("EXCR_Commons_API.Document")) {
			return excr_commons_api.proxies.Document.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("EXCR_EProcedure_API.EProcedureDocument")) {
			return excr_eprocedure_api.proxies.EProcedureDocument.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("SAML20.IdPMetadata")) {
		...
		if (mendixObject.isInstanceOf("SAML20.KeyStore")) {
		...
		if (mendixObject.isInstanceOf("SAML20.X509Certificate")) {
