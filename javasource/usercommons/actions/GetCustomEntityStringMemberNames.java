...
public class GetCustomEntityStringMemberNames extends UserAction<java.util.List<IMendixObject>>
{
	...
	public GetCustomEntityStringMemberNames(
		IContext context,
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		fields.forEach(field -> {
			if (field.getType() == IMetaPrimitive.PrimitiveType.String) {
				IMendixObject customUserEntityMember = Core.instantiate(getContext(), CustomEntityMember.entityName);
				customUserEntityMember.setValue(getContext(), CustomEntityMember.MemberNames.Name.name(),
						field.getName());
	...
	{
		return "GetCustomEntityStringMemberNames";
	}
