...
import saml20.proxies.SAMLSession;
...
public class LogoutHandler extends SAMLHandler {
    ...
    public void handleLogoutRequest(SAMLRequestContext context, IMxRuntimeRequest request) throws SAMLException, CoreException {
        ...
        // log the messages
        SAMLUtil.logSAMLRequestMessage(context, java.util.UUID.randomUUID().toString(), new MxSAMLRequest(logoutRequest, relayState), metadata.getSsoConfiguration());
