...
public class Constants {
    ...
    // used for verification attempts, where no session is created: appname/sso/login?action=verify
    public static final String SSO_ACTION_PARAMETER = "action";
    public static final String SSO_ACTION_VERIFY = "verify";
    public static final String RELAYSTATE_VERIFY = "v";
    public static final String RELAYSTATE_LOGIN = "l";
    // To transfer state between pre- and post-signin
    public static final String SSO_CONTEXT_PARAMETER = "on";
    ...
    public static Map<SAMLAction, SAMLHandler> getHandlers() {
        ...
        handlers.put(SAMLAction.SubmitLoginForm, new SubmitLoginFormJSHandler());
    ...
    public enum SAMLAction {
        login, logout, assertion, metadata, discovery, delegatedAuthentication,SubmitLoginForm
    }
    ...
    public static String getSSOActionParameter(){
        return prepareQueryParameter(Constants.SSO_ACTION_PARAMETER,Constants.SSO_ACTION_VERIFY);
    }

    public static String getSSOContextParameter(String value){
        return prepareQueryParameter(Constants.SSO_CONTEXT_PARAMETER,value);
    }

    public static String prepareQueryParameter(String paramName,String paramValue){
        return String.format("&%s=%s",paramName,paramValue);
    }

    public static String getContinuationParameter(String value){
        return prepareQueryParameter(Constants._getInstance().SSO_CONTINUATION_PARAMETER,value);
    }
}
