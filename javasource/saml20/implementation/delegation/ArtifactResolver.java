...
public class ArtifactResolver {
    ...
    private static boolean useSamlArt(HttpServletRequest request) {
        ...
        if (_logNode.isDebugEnabled())
            _logNode.debug("Use SAML Artifact: "+useSamlArt);
        return useSamlArt;
    }
    ...
    private static MxSAMLResponse resolveArtifactResponse(SAMLRequestContext context) throws SAMLException {
        ...
        if (_logNode.isDebugEnabled())
            _logNode.debug("Artifact: " + artifact.getArtifact());
        ...
        if (_logNode.isDebugEnabled())
            _logNode.debug("ArtifactResolve: ");
        ...
        if (_logNode.isDebugEnabled())
            _logNode.debug("ArtifactResponse received");
