...
public final class Microflows
{
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder dOC_DHR_PrintAsPDFBuilder(
		excr_resourcemanagement.proxies.DHRHolder _dHRHolder
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("DocumentGeneration.DOC_DHR_PrintAsPDF");
		builder = builder.withParam("DHRHolder", _dHRHolder);
		return builder;
	}

	public static void dOC_DHR_PrintAsPDF(
		IContext context,
		excr_resourcemanagement.proxies.DHRHolder _dHRHolder
	)
	{
		dOC_DHR_PrintAsPDFBuilder(
				_dHRHolder
			)
			.execute(context);
	}
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder oP_DHR_PrintBuilder(
		excr_resourcemanagement.proxies.DHRHolder _dHRHolder
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("DocumentGeneration.OP_DHR_Print");
		builder = builder.withParam("DHRHolder", _dHRHolder);
		return builder;
	}

	public static void oP_DHR_Print(
		IContext context,
		excr_resourcemanagement.proxies.DHRHolder _dHRHolder
	)
	{
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder sUB_DHRDocument_GenerateBuilder(
		excr_resourcemanagement.proxies.DHRHolder _dHRHolder
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("DocumentGeneration.SUB_DHRDocument_Generate");
		builder = builder.withParam("DHRHolder", _dHRHolder);
		return builder;
	}

	public static void sUB_DHRDocument_Generate(
		IContext context,
		excr_resourcemanagement.proxies.DHRHolder _dHRHolder
	)
	{
		sUB_DHRDocument_GenerateBuilder(
				_dHRHolder
			)
			.execute(context);
	}
