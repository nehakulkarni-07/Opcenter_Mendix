...
package excr_authentication.actions;
...
public class SetSessionData extends UserAction<java.lang.Boolean>
{
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		try {
			...
			IUser user = Core.getUser(ctx, Username);
			
			IContext ctx2 = Core.createSystemContext();
			IUser user2 = Core.getUser(ctx2,  Username);
			
			if (user != null) {
				ISession session = Core.initializeSession(user2, null);
